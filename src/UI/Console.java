...
public class Console {
    ...
    public void functii(){
        while (true){
            ...
            switch (optiune){
                case "1": functiiFilmCrud();
                break;
                case "2": functiiClientCrud();
                break;
                case "3": functiiRezervareCrud();
                break;
                case "x": return;
    ...
    private void functiiFilmCrud() {
        while (true){
            ...
            switch (optiune){
                case "1": adaugareFilm();
                case "2": actualizareFilm();
                case "3": stergereFilm();
                case "4": afisareToateFilmele();
                case "x": return;
                default:System.out.println("Optiune invalida");
            }
        }
    ...
    private void functiiClientCrud() {
        while (true){
            ...
            String optiune = scanner.nextLine();
            switch (optiune){
                case "1": adaugareClient();
                case "2": actualizareClient();
                case "3": stergereClient();
                case "4": afisareTotiClientii();
                case "x": return;
                default:System.out.println("Optiune invalida");
            }
        }
    ...
    private void actualizareClient(){
        try {
            ...
            clientService.adauga(id, nume, prenume, cnp, dataNastere, dataInregistrare, puncte);
    ...
    private void functiiRezervareCrud() {
        while (true){
            ...
            String optiune = scanner.nextLine();
            switch (optiune){
                case "1": adaugareRezervare();
                case "2": actualizareRezervare();
                case "3": stergereRezervare();
                case "4": afisareToateRezervarile();
                case "x": return;
                default:System.out.println("Optiune invalida");
            }
        }
